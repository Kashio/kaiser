...
/**
 * Transform a resource by changing all links to relative paths
 *
 ...
 * replace any link that is allowed to be fetched by a relative path
 * and any link that is not allowed to be fetched by an absolute http:// path
 *
 * @param {Resource} resource
...
BasicTransformer.prototype.getUris = function(resource, callback) {
	...
	self.replaceResourceContent(resource, notAllowedUris, self.calculateReplacePortionOfNotAllowedUris, function(/*eslint-disable no-unused-vars*/err/*eslint-enable no-unused-vars*/, result) {
...
/**
 * Calculate the new relative uri path of allowed to be fetched uris
 *
 * @param {Resource} resource
 * @param {string} uri
 * @returns {String}
...
/**
 * Calculate the new absolute http:// uri path of not allowed to be fetched uris
 *
 * @param {Resource} resource
 * @param {String} uri
 * @returns {String}
